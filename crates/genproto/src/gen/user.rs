...
pub struct UserResponse {
    ...
    pub email: ::prost::alloc::string::String,
    #[prost(string, tag = "5")]
    pub noc_transfer: ::prost::alloc::string::String,
    #[prost(string, tag = "6")]
...
pub struct ApiResponsesUserPaginated {
    #[prost(string, tag = "1")]
    pub status: ::prost::alloc::string::String,
    #[prost(string, tag = "2")]
    pub message: ::prost::alloc::string::String,
...
pub mod user_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn find_all_users(
            ...
            tonic::Response<super::ApiResponsesUserPaginated>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            match req.uri().path() {
                "/user.UserService/FindAllUsers" => {
                    ...
                    for FindAllUsersSvc<T> {
                        type Response = super::ApiResponsesUserPaginated;
